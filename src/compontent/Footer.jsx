  ...
  return (
    <>
      ...
      <div className='flex justify-center relative mt-30'>
        <input className=' border-1 border-black h-12 outline-none w-md  md:w-lg rounded-2xl ps-5  bg-white-950 text-black hover:shadow-2xl  absolute  transform -translate-y-7 translate-x-3' type='email' value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Email@gmail' required />
